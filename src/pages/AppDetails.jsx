...
const AppDetails = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8F6FF] flex flex-col px-4 sm:px-[100px] py-14">
      {/* App Info */}
        ...
        <div className="flex-1 flex flex-col justify-between">
          <div>
            ...
            <p className="text-[#555] text-[18px] sm:text-[20px] leading-[30px] mb-4">
              Developed by <span className="text-[#7b43e9] font-medium">{app.companyName}</span>
            </p>
      ...
      <div className="mb-12 max-w-[1200px] space-y-4 relative">
        ...
        {[5, 4, 3, 2, 1].map((star) => {
          ...
          return (
            ...
            >
              <span className="w-[50px] sm:w-[60px] text-[#627382] text-[16px] sm:text-[18px]">{star} star</span>
